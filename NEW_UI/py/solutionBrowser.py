...
class Ui_CornerStitch_Dialog(object):
    def setupUi(self, CornerStitch_Dialog):
        ...
        sizePolicy.setHeightForWidth(self.grview_layout_sols.sizePolicy().hasHeightForWidth())
        self.grview_layout_sols.setSizePolicy(sizePolicy)
        self.grview_layout_sols.setMaximumSize(QtCore.QSize(1000, 1000))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.grview_init_layout.sizePolicy().hasHeightForWidth())
        self.grview_init_layout.setSizePolicy(sizePolicy)
        self.grview_init_layout.setMaximumSize(QtCore.QSize(1000, 500))
