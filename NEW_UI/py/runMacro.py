...
# Form implementation generated from reading ui file 'NEW_UI/ui/runMacro.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Run Project"))
        self.label.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-weight:600;\">Please provide the paths to the settings.info and macro_script.txt files.</span></p></body></html>"))
        self.label_3.setText(_translate("Dialog", "Path to settings.info"))
        self.btn_open_settings_2.setText(_translate("Dialog", "Open"))
        self.label_4.setText(_translate("Dialog", "Path to macro_script.txt"))
        self.btn_open_macro.setText(_translate("Dialog", "Open"))
        self.btn_create_project.setText(_translate("Dialog", "Run Project"))
