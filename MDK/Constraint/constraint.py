...
def init_constraint_table(all_components=None):

    '''
    Initializes constraint table for the structure. Assumes each layer has same constraint table. So, there will be a single constraint table for single 3D structure
    :param all_components: list of all components in the layout script. Accumulated list from each layer.
    '''
