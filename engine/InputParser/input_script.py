...
if __name__ == '__main__':
    ...
    input_geometry_script='/nethome/ialrazi/PS_2_test_Cases/Regression_Test_Suits/Code_Migration_Test/layout_geometry_script1.txt'
    new_layer_stack_file = "/nethome/ialrazi/PS_2_test_Cases/Regression_Test_Suits/Code_Migration_Test/layer_stack.csv"
    bondwire_info_file='/nethome/ialrazi/PS_2_test_Cases/Regression_Test_Suits/Code_Migration_Test/bond_wires_setup.txt'
    layer_stack = LayerStack(debug=False)
    layer_stack.import_layer_stack_from_csv(filename=new_layer_stack_file)
    all_layers,via_connected_layer_info=script_translator(input_script=input_geometry_script,layer_stack_info=layer_stack,bond_wire_info=bondwire_info_file)
    try:
