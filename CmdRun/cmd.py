...
if __name__ == "__main__":
    ...
    if debug: # you can mannualy add the argument in the list as shown here
        ...
        if sel == 1: 
            ...
            args = ['python','cmd.py','-m','/nethome/ialrazi/PS_2_test_Cases/Regression_Test_Suits_Migrated_Codebase/Case_9/macro_script.txt','-settings',"/nethome/ialrazi/PS_2_test_Cases/settings.info"]
